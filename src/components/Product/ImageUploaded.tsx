...
const ImageUploaded: React.FC<{ imageField: FieldArrayWithId<Product, "images", "id">; index: number, control: Control<Product> | undefined, removeImage: UseFieldArrayRemove }> = ({ imageField, index, control, removeImage }) => {
